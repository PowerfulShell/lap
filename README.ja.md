...
| **Windows 10/11 (x64)** | `.msi` | 現在未署名（SmartScreenの警告が表示される場合があります） |
| **Ubuntu/Debian (amd64)** | `amd64.deb` | Linux Mintで動作確認済み。動画再生の利用に関する注意点は以下のLinuxの備考をご覧ください。 |
...
- **大規模ライブラリ向け**: 数千枚の写真や動画でもスムーズな閲覧と整理が可能です。

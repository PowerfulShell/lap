...
| **Windows 10/11 (x64)** | `.msi` | 暂无签名 (可能会显示 SmartScreen 警告) |
| **Ubuntu/Debian (amd64)** | `amd64.deb` | 在 Linux Mint 上通过验证。关于视频播放支持，请参阅下方的 Linux 备注。 |
...
- **专为海量库打造**：在成千上万张照片和视频中提供流畅的浏览与组织体验。

...
| **Windows 10/11 (x64)** | `.msi` | На данный момент без подписи (может появиться предупреждение SmartScreen) |
| **Ubuntu/Debian (amd64)** | `amd64.deb` | Проверено на Linux Mint. Для лучшей поддержки воспроизведения видео см. примечание для Linux ниже. |
...
- **Создано для больших библиотек**: плавный просмотр и организация тысяч фотографий и видео.
